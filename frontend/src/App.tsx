...
export default function App() {
  ...
  async function ask(message=chatText){
    ...
    try{
      ...
      const answer=await api<{message:string;mode:string;request:SavedRequest;result:Result|null;alternatives:Alternative[]}>(`/chat/messages`,{request_id:item.id,expected_revision:item.revision,message:text});
      ...
      setSelected([]);setAlternatives([]);setAlternativesLoaded(false);
